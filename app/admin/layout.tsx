...
import { LayoutDashboard, Package, Settings, LogOut, Cat, ChevronRight, CreditCard, Bot, Users, ClipboardList } from 'lucide-react';
...
export default function AdminLayout({ children }: AdminLayoutProps) {
    ...
    const navItems = [
        ...
        { label: 'Orders & Sourcing', href: '/admin/orders', icon: <Settings className="w-5 h-5" /> },
        { label: 'Affiliates', href: '/admin/affiliate', icon: <Users className="w-5 h-5" /> },
        ...
        { label: 'PayPal', href: '/admin/paypal', icon: <CreditCard className="w-5 h-5" /> },
        { label: 'OpenClaw Tester', href: '/admin/openclaw', icon: <Bot className="w-5 h-5" /> },
        { label: 'Audit Logs', href: '/admin/audit-logs', icon: <ClipboardList className="w-5 h-5" /> },
    ];
