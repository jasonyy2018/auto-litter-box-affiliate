...
export const ALitterTrustBar: React.FC = () => {
    const trustItems = [
        {
            icon: Truck,
        ...
        {
            icon: RotateCcw,
            title: '365-Day Hassle-Free Guarantee',
            subtitle: '100% Unconditional cat parent satisfaction',
            badge: 'ALITTER CARE',
        ...
        },
        {
            ...
            subtitle: 'Flexible scheduled refills & extra savings',
            badge: 'AUTOSHIP',
            badgeColor: 'bg-purple-500/10 text-purple-400',
        },
        {
            icon: HeartHandshake,
            title: '24/7 Cat Specialist Support',
            subtitle: 'Connect with verified feline care experts anytime',
            badge: '24/7 SUPPORT',
...
export default ALitterTrustBar;
